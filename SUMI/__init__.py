...
if ENV:
    ...
    REDIS_URL = os.environ.get("REDIS_URL", "redis-cli -u redis://default:SB9izW2azCnYLyj66ysVyn24f1C3X2DB@redis-17361.c266.us-east-1-3.ec2.cloud.redislabs.com:17361") # REDIS URL (From:- Heroku & Redis)
